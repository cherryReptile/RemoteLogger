...
func (c *authServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisteredResponse, error) {
...
func (UnimplementedAuthServiceServer) Register(context.Context, *RegisterRequest) (*RegisteredResponse, error) {
